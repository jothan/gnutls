...
static const gnutls_sign_entry sign_algorithms[] = {
  ...
  {"ECDSA-SHA1", SIG_ECDSA_SHA1_OID, GNUTLS_SIGN_ECDSA_SHA1, GNUTLS_PK_ECDSA,
   GNUTLS_MAC_SHA1, {2, 3}},
  {"ECDSA-SHA224", SIG_ECDSA_SHA224_OID, GNUTLS_SIGN_ECDSA_SHA224, GNUTLS_PK_ECDSA,
   GNUTLS_MAC_SHA224, {3, 3}},
  {"ECDSA-SHA256", SIG_ECDSA_SHA256_OID, GNUTLS_SIGN_ECDSA_SHA256, GNUTLS_PK_ECDSA,
   GNUTLS_MAC_SHA256, {4, 3}},
  {"ECDSA-SHA384", SIG_ECDSA_SHA384_OID, GNUTLS_SIGN_ECDSA_SHA384, GNUTLS_PK_ECDSA,
   GNUTLS_MAC_SHA384, {5, 3}},
  {"ECDSA-SHA512", SIG_ECDSA_SHA512_OID, GNUTLS_SIGN_ECDSA_SHA512, GNUTLS_PK_ECDSA,
   GNUTLS_MAC_SHA512, {6, 3}},
...
static const gnutls_pk_entry pk_algorithms[] = {
  ...
  {"ECDSA", PK_ECDSA_OID, GNUTLS_PK_ECDSA},
  {0, 0, 0}
};
